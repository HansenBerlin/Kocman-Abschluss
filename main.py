...
#plotCanvas = gui.Canvas(key='plotCanvas', pad=([50,0],[50,0]), size=(300,300))
plotCanvas = gui.Image(key='plotCanvas', pad=([50,0],[50,0]), size=(300,300))
...
rightColumn = [[infoTextRowNamesUserSelection, infoTextCurrentUserSelection],[plotCanvas]]
