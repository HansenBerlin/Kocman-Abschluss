...
class UserSelectionView():
    ...
    def initMainWindow():
        ...
        window = gui.Window('nifty n00b notebook-builder', layout, margins=(0,0), element_padding=(0,0), no_titlebar=False, grab_anywhere=False, use_default_focus=False, icon=imageData.iconMainWindow, font='Consolas', finalize=True)
        window.hide()
